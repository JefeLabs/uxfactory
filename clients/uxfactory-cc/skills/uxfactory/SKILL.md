...
A spec is one of three shapes. The authoritative contract is the JSON Schema (`packages/uxfactory-spec/schema/uxfactory.schema.json`); run `uxfactory lint <spec.json>` to validate before publishing.
