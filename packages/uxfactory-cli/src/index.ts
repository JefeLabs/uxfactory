...
export { svgToPngPlaywright } from "./render/raster-playwright.js";
export { selectRasterizer, rasterize } from "./render/raster-select.js";
export type { PlaywrightRasterizerDeps } from "./render/raster-select.js";
...
export { scaffoldSpec, scaffoldSpecs, sanitizeFileName } from "./batch/scaffold-specs.js";
export type { ScaffoldedSpec } from "./batch/scaffold-specs.js";
export { generateSpecsCmd } from "./commands/generate-specs.js";
export type { GenerateSpecsFlags } from "./commands/generate-specs.js";
