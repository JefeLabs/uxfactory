...
and the gate runs over the union of snapshots — with story coverage required
per viewport (every story×state must be visibly covered at every rendered
viewport). Absent → the legacy single 390×844 render.
